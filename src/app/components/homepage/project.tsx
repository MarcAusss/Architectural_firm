  ...
  const projects: Project[] = [
    {
      ...
      title: "Project Alpha",
      description:
        "A cutting-edge solution designed for modern challenges in tech.",
    ...
    },
    {
      ...
      title: "Project Beta",
      description:
        "A creative and collaborative project that changed how we interact.",
      image: "/img/image.png",
    ...
    },
    {
      ...
      title: "Project Gamma",
      description:
        "Focused on innovation in sustainability and green technology.",
  ...
  return (
    <div className="my-20">
      ...
      <div className="max-w-[93rem] mx-auto">
        <div className="flex gap-3 w-full h-[500px] group">
...
function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div
      className={`
        relative h-full overflow-hidden rounded-lg shadow-lg cursor-pointer transition-all duration-500 ease-in-out
        group/item
        group-hover:w-[450px]
        hover:!w-[600px]
        w-[500px]
    ...
    >
      ...
      {/* Slideshow images (appear on hover) */}
